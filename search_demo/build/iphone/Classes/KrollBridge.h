...
@interface search_demoObject : KrollCoverageObject {
#else
@interface search_demoObject : KrollObject {
#endif
@private
...
extern NSString * search_demo$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	search_demoObject *_search_demo;
    KrollObject* console;
	BOOL shutdown;
