...
//@interface search_demoObject : NSObject
//@end

@interface search_demoObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[search_demoObject class]])
		{
			for (NSString *key in [[(search_demoObject*)o modules] allKeys])
			{
