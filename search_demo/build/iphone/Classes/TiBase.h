...
// in simulator we redefine to format for search_demo Developer console
...
{\
	NSString * exceptionName = [@"org.search_demo." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.search_demo";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIsearch_demoNativeItemNone = -1, 
	UIsearch_demoNativeItemSpinner = -2,
	UIsearch_demoNativeItemProgressBar = -3,
	
	UIsearch_demoNativeItemSlider = -4,
	UIsearch_demoNativeItemSwitch = -5,
	UIsearch_demoNativeItemMultiButton = -6,
	UIsearch_demoNativeItemSegmented = -7,
	
	UIsearch_demoNativeItemTextView = -8,
	UIsearch_demoNativeItemTextField = -9,
	UIsearch_demoNativeItemSearchBar = -10,
	
	UIsearch_demoNativeItemPicker = -11,
	UIsearch_demoNativeItemDatePicker = -12,
	
	UIsearch_demoNativeItemInfoLight = -13,
	UIsearch_demoNativeItemInfoDark = -14,
	
	UIsearch_demoNativeItemDisclosure = -15,
	
	UIsearch_demoNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all search_demo instances of
