...
/**
 The base class for all search_demo modules
 */
...
/**
 search_demo Platform calls this method on startup.
 */
-(void)startup;

/**
 search_demo Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 search_demo Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 search_demo Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 search_demo Platform calls this method on resume.
 @param sender The sender of the event.
 */
