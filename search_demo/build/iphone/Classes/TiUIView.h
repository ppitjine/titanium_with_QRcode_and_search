...
/**
 Base class for all search_demo views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the search_demo view hierarchy (such as wrapped iOS UIViews) was touched.
